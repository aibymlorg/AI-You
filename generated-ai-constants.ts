import { ModuleData, Question } from './generated-ai-types';
...
export const INTRO_TEXT = [
  ...
  "STATUS: FRAGMENTED.",
  "MISSION: UNDERSTAND THE RISE OF MODERN AI.",
];
...
export const MODULES: ModuleData[] = [
  ...
  },
  {
    ...
    content: [
      {
        heading: "Beyond Text",
        body: "Current AI is great at generative AI (LLMs). The next frontier is 'Spatial Intelligence'. Her startup, World Labs, focuses on this."
      },
      {
