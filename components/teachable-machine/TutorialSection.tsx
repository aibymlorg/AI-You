        ...
        <div className="flex flex-col gap-6">
          <div className="h-48 flex items-center justify-center relative">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-3">
                <span className="text-gray-500 font-bold text-lg">{t('teachableMachine.class')} 1</span>
              ...
              <div className="flex items-center gap-3">
                <span className="text-gray-500 font-bold text-lg">{t('teachableMachine.class')} 2</span>
                <div className="flex gap-1">
                  {[4, 5, 6].map(i => (
                    <div key={i} className="w-12 h-12 bg-blue-100 rounded flex items-center justify-center">
          ...
          <div className="space-y-4">
            <div className="flex items-baseline gap-3">
              ...
              <h3 className="text-2xl font-medium text-gray-900">{t('teachableMachine.step1Title')}</h3>
            </div>
            <p className="text-gray-800 leading-relaxed text-lg">
              {t('teachableMachine.step1Desc')}
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6">
          <div className="h-48 flex items-center justify-center">
            ...
            <div className="relative">
              <div className="bg-[#d2e3fc] text-[#1967d2] px-8 py-3 rounded font-bold text-lg tracking-wide shadow-sm">
                {t('teachableMachine.trainModelButton')}
              </div>
          ...
          <div className="space-y-4">
            <div className="flex items-baseline gap-3">
              ...
              <h3 className="text-2xl font-medium text-gray-900">{t('teachableMachine.step2Title')}</h3>
            </div>
            <p className="text-gray-800 leading-relaxed text-lg">
              {t('teachableMachine.step2Desc')}
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6">
          <div className="h-48 flex items-center justify-center">
            ...
            <div className="relative w-48 h-32 bg-[#d2e3fc] rounded-lg p-3 flex flex-col shadow-inner">
               <div className="text-[#1967d2] font-bold text-xs mb-2 text-center">{t('teachableMachine.myProject')}</div>
               ...
               <div className="absolute -right-4 -bottom-4 w-16 h-28 bg-[#d2e3fc] rounded-lg border-2 border-white shadow-lg flex flex-col items-center p-1">
                  <div className="text-[6px] text-[#1967d2] font-bold mt-1">{t('teachableMachine.myProject')}</div>
          ...
          <div className="space-y-4">
            <div className="flex items-baseline gap-3">
              ...
              <h3 className="text-2xl font-medium text-gray-900">{t('teachableMachine.step3Title')}</h3>
            </div>
            <p className="text-gray-800 leading-relaxed text-lg">
              {t('teachableMachine.step3Desc')}
            </p>
          </div>
        </div>
