...
import { Database, Brain, Eye, Shield, Lock, PlayCircle, Trophy, Video } from 'lucide-react';
import { MODULES, TOTAL_XP_TO_WIN } from '../../generated-ai-constants';
import { UserState, ModuleData } from '../../generated-ai-types';
    ...
    <div className="w-full max-w-6xl mx-auto p-6 relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <motion.div
           ...
           className="relative p-6 rounded-2xl border-2 border-red-500/30 bg-gradient-to-br from-red-900/40 to-slate-900 h-64 flex flex-col justify-center items-center text-center transition-all hover:scale-105 cursor-pointer hover:shadow-lg hover:shadow-red-500/20 overflow-hidden group"
           onClick={() => window.open('https://youtu.be/E2yzX6Gch40?si=-9hiNxjvrIFqazNW', '_blank')}
        >
            ...
            <h3 className="text-2xl font-bold font-display text-white mb-2">GodMother AI</h3>
            <p className="text-sm text-slate-400 mb-4">
              Watch exclusive interview with Dr. Fei-Fei Li
            </p>
            <div className="flex items-center gap-2 text-red-400 opacity-0 group-hover:opacity-100 transition-opacity">
              <PlayCircle className="w-5 h-5" />
              <span className="text-xs font-bold uppercase">Watch Interview</span>
            </div>
        </motion.div>
      </div>
    </div>
